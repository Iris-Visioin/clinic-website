  ...
  <div className="mt-6 flex justify-end">
    <span className="text-blue-900 text-lg font-bold italic">فريق آيرس</span>
      ...
      <section className="w-full max-w-3xl mb-12">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4 text-center">خدماتنا</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

          <div className="border-2 border-blue-400 rounded-xl p-6 shadow-[0_0_15px_2px_rgba(59,130,246,0.5)] transition-shadow duration-300 hover:shadow-[0_0_25px_6px_rgba(59,130,246,0.8)] text-center">
      ...
      <section className="w-full max-w-3xl mb-12">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4 text-center">من نحن</h2>
        <div className="bg-white rounded-xl p-6  shadow text-gray-700 text-center border shadow border-2 border-blue-400 shadow-[0_0_15px_2px_rgba(59,130,246,0.5)] transition-shadow duration-300 hover:shadow-[0_0_25px_6px_rgba(59,130,246,0.8)]">
          <p>
      ...
      <section className="w-full max-w-3xl mb-12 contact-us-section">
        <h2 className="text-2xl font-semibold text-blue-700 mb-4 text-center">تواصل معنا</h2>
        <div className="bg-white rounded-xl p-6 shadow text-gray-700 shadow border-2 border-blue-400 shadow-[0_0_15px_2px_rgba(59,130,246,0.5)] transition-shadow duration-300 hover:shadow-[0_0_25px_6px_rgba(59,130,246,0.8)]">
